...
import { OutroOverlay } from './overlays/OutroOverlay.js'; // <<< NEW IMPORT
...
export class OverlayManager {
    constructor() {
        ...
        this.brbOverlay = new BRBOverlay('brb-overlay-container', 
            () => { // onShow
                ...
                this.outroOverlay.hide(); // <<< HIDE OUTRO
        ...
        this.outroOverlay = new OutroOverlay('outro-overlay-container', // <<< NEW INSTANCE
            () => { // onShow for Outro
                this.brbOverlay.hide();
                this.csoOverlay.hide();
                this.hideAllNonFullscreenOverlays();
    ...
    // ... (initialize, connectToAbly, publishStatus methods remain the same) ...
    async initialize() { /* ... same ... */ }
    connectToAbly() { /* ... same, including the logic in 'connected' for attaching channels and publishing initial states ... */ }
    ...
    subscribeToAblyEvents() {
        ...
        const createActionHandler = (overlayStringId, overlayInstance) => (message) => {
            // ... (logic inside createActionHandler remains the same)
        ...
        this.controlChannel.subscribe('outro-action', createActionHandler('outro', this.outroOverlay)); // <<< NEW SUBSCRIPTION
